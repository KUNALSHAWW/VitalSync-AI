...
help: ## Show this help message
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
	@echo "$(GREEN)  VitalSync AI - Intelligent Triage Assistant$(NC)"
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
	@echo ""
	...
	@echo ""
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
	@echo "$(YELLOW)Author:$(NC) Kunal Shaw"
	@echo "$(YELLOW)Website:$(NC) https://github.com/KUNALSHAWW"
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
...
run-chatbot: ## Run the VitalSync AI triage application
	@echo "$(BLUE)Starting VitalSync AI...$(NC)"
	$(PYTHON) 5-HuggingFace/app.py
	@echo "$(GREEN)✓ VitalSync started$(NC)"

run-interviewer: ## Run the VitalSync interviewer application
	@echo "$(BLUE)Starting VitalSync Interviewer...$(NC)"
...
version: ## Show version information
	...
	@echo "$(YELLOW)Project:$(NC) VitalSync AI"
...
info: ## Show project information
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
	@echo "$(GREEN)  VitalSync AI - Project Information$(NC)"
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
	@echo ""
	@echo "$(YELLOW)Project Name:$(NC)    VitalSync AI"
	@echo "$(YELLOW)Version:$(NC)        1.0.0"
	@echo "$(YELLOW)Author:$(NC)         Kunal Shaw"
	@echo "$(YELLOW)Website:$(NC)        https://github.com/KUNALSHAWW"
	@echo "$(YELLOW)License:$(NC)        Apache 2.0"
	@echo "$(YELLOW)Description:$(NC)    Intelligent Triage Assistant - Bridging the gap between symptoms and care"
	@echo ""
	@echo "$(BLUE)═══════════════════════════════════════════════════════════════$(NC)"
